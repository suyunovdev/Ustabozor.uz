...
import { ShieldOff, Clock, AlertTriangle, LogOut, MessageCircle } from 'lucide-react';
...
export const BannedScreen: React.FC<BannedScreenProps> = ({ reason, blockedUntil, blockedAt, onLogout }) => {
    const isExpired = blockedUntil && new Date(blockedUntil).getTime() < Date.now();
                ...
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-red-200 dark:border-red-900/50 overflow-hidden">
                    ...
                    <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Sabab</p>
                    ...
                    <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Muddat</p>
                                <p className="text-gray-900 dark:text-white font-medium">
