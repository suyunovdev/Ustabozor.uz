...
export default function CustomerProfile() {
  ...
  const handleAvatarChange = async () => {
    ...
    try {
      ...
      Alert.alert('Xato', e.message || 'Rasm yuklashda xatolik');
    ...
    <ScrollView style={styles.root} contentContainerStyle={styles.scroll}>
      ...
      <View style={styles.headerBg}>
        ...
        <View style={styles.roleBadge}>
          <Text style={styles.roleText}>Mijoz</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        {[
          ...
          { label: '📧 Email', value: user.email || 'Ko\'rsatilmagan' },
...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: 'rgba(255,255,255,0.25)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 },
  roleText: { fontSize: 13, color: '#fff', fontWeight: '600' },
  statsRow: { flexDirection: 'row', margin: 16, gap: 12 },
  statCard: { flex: 1, backgroundColor: '#fff', borderRadius: 16, padding: 16, alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 8, elevation: 2 },
  statValue: { fontSize: 20, fontWeight: '800', color: COLORS.primary },
  statLabel: { fontSize: 12, color: COLORS.gray[400], marginTop: 4 },
  section: { backgroundColor: '#fff', marginHorizontal: 16, borderRadius: 16, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 8, elevation: 1 },
